        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" aria-current="page" class="<?=selectNavByURI("/")?> rounded-md px-3 py-2 text-sm font-medium">Home</a>
              <a href="/about" class="<?=selectNavByURI("/about")?> rounded-md px-3 py-2 text-sm font-medium">About</a>
              <a href="/contact" class="<?=selectNavByURI("/contact")?> rounded-md px-3 py-2 text-sm font-medium">Contact</a>
              <a href="/notes" class="<?=selectNavByURI("/notes")?> rounded-md px-3 py-2 text-sm font-medium">Notes</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
          ...
          <el-dropdown class="relative ml-3">
            ...
            <?php else : ?>
                <a href="/register" class="text-white text-xl text-xlhover:text-blue-500">Register</a>
            <?php endif; ?>
